...
mkvar <- gsub("@tiledb_rpath@", "-Wl,-rpath,'$$ORIGIN/../tiledb/lib' -Wl,-rpath,'$$ORIGIN/../tiledbsoma/lib' -Wl,-rpath,'$$ORIGIN/../inst/tiledb/lib' -Wl,-rpath,'$$ORIGIN/../inst/tiledbsoma/lib'", mkvar)
