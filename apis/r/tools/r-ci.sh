...
Coverage() {
    ...
    echo COVR="true" Rscript -e "covr::codecov(path = '${COVERAGE_PATH}', type = '${COVERAGE_TYPE}', token = '${COVERAGE_TOKEN}', flags = '${COVERAGE_FLAGS}', quiet = FALSE, relative_path = getwd())"
    COVR="true" Rscript -e "covr::codecov(path = '${COVERAGE_PATH}', type = '${COVERAGE_TYPE}', token = '${COVERAGE_TOKEN}', flags = '${COVERAGE_FLAGS}', quiet = FALSE, relative_path = getwd())"
}
